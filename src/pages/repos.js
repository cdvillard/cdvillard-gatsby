  ...
  return (
    <DefaultLayout>
      ...
      <Repo
        ...
        reponame="Oye Socio"
        excerpt={
          "Oye Socio brings many of the key features of social media network to email users. This repo represents the front-end for Oye Socio."
        }
        styles={styles}
      />
    </DefaultLayout>
